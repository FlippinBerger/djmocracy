...
export default function Index() {
  ...
  return (
    <main className="h-full min-h-screen bg-slate-950 pt-2 flex justify-between">
      {user ? (
        <div className="h-full min-h-screen w-full flex flex-col items-center justify-between"> {/*className="mx-auto flex flex-col gap-2 items-center justify-center">*/}
          <header className="flex items-center justify-between w-full p-4 text-gray-300 border-b">
            ...
            <Link to="/profile" className="hover:text-blue-500">{user.email}</Link>
